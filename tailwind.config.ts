  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(var(--glow-teal) / 0.3)" },
          "50%": { boxShadow: "0 0 40px hsl(var(--glow-teal) / 0.6)" },
        },
        "pulse-ember": {
      ...
      animation: {
        ...
        "thunder-flash": "thunder-flash 8s ease-in-out infinite",
      },
      backgroundImage: {
