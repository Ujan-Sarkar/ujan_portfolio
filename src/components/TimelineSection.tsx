...
const timelineEvents: TimelineEvent[] = [
  {
    ...
    description: "Began the journey into software development, discovering the vast digital wilderness.",
    type: "expedition",
  },
  {
    id: 2,
    ...
    description: "Mastered modern frontend frameworks and built first production applications.",
    type: "discovery",
  },
  {
    id: 3,
    ...
    description: "Ventured into backend development, databases, and cloud architecture.",
    type: "expedition",
  },
  {
    id: 4,
    ...
    description: "Led development of enterprise-scale applications with millions of users.",
    type: "achievement",
  },
  {
    id: 5,
    ...
    description: "Explored AI/ML integration, 3D web experiences, and immersive technologies.",
    type: "discovery",
  },
  {
    id: 6,
    ...
    description: "Pushing boundaries with cutting-edge web technologies and creative innovations.",
    type: "expedition",
  },
];
